 ...
 *
 * @author mingbo.tang
 * @version $Id: TestRocketmqStringListener.java,v 0.1 2018年01月07日 下午 14:45 $Exp
 */
@Service("testRocketmqStringListener")
public class TestRocketmqStringListener extends AbstractMessageListenerConcurrently {
