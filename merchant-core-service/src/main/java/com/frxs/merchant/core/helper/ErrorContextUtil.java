...
import com.frxs.merchant.common.dal.enums.ErrorCodeEnum;
...
public class ErrorContextUtil {
   ...
   * @return 错误上下文
   */
  public static ErrorContext generateErrorContext(ErrorCodeScenarioEnum scenario, BaseMerchantException e) {
    //获取现有错误上下文
